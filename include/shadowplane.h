...
double (__stdcall * X3D_ShadowplaneCreate)(double width, double height,
                                           double xtiles, double ytiles,
                                           double target, double light,
...
double (__stdcall * X3D_ShadowplaneSetOptions)(double sp, double stencil,
                                               double scissor,
                                               double transparent,
                                               double ignorez);
