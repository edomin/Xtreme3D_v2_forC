...
double (__stdcall * X3D_CameraMoveAroundTarget)(double cam, double pitch, double turn);
...
double (__stdcall * X3D_CameraCopyToTexture)(double cam, char * material, double width, double height);
