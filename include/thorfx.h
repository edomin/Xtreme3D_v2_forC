...
double (__stdcall * X3D_ThorFXSetColor)(double fm, double inc, double ina, double outc, double outa, double cc, double ca);
...
double (__stdcall * X3D_ThorFXSetTarget)(double fm, double x, double y, double z);
