...
double (__stdcall * X3D_OdeDynamicSetAutoDisableLinearThreshold)(double object, double velocity);
double (__stdcall * X3D_OdeDynamicSetAutoDisableAngularThreshold)(double object, double velocity);
double (__stdcall * X3D_OdeDynamicSetAutoDisableSteps)(double object, double steps);
double (__stdcall * X3D_OdeDynamicSetAutoDisableTime)(double object, double time);
...
double (__stdcall * X3D_OdeDynamicAddForce)(double object, double x, double y, double z);
double (__stdcall * X3D_OdeDynamicAddForceAtPos)(double object, double x, double y, double z, double px, double py, double pz);
double (__stdcall * X3D_OdeDynamicAddForceAtRelPos)(double object, double x, double y, double z, double px, double py, double pz);
double (__stdcall * X3D_OdeDynamicAddRelForce)(double object, double x, double y, double z);
double (__stdcall * X3D_OdeDynamicAddRelForceAtPos)(double object, double x, double y, double z, double px, double py, double pz);
double (__stdcall * X3D_OdeDynamicAddRelForceAtRelPos)(double object, double x, double y, double z, double px, double py, double pz);
double (__stdcall * X3D_OdeDynamicAddTorque)(double object, double x, double y, double z);
...
double (__stdcall * X3D_OdeAddBox)(double object, double width, double height, double depth);
double (__stdcall * X3D_OdeAddCapsule)(double object, double length, double radius);
double (__stdcall * X3D_OdeAddCone)(double object, double length, double radius);
double (__stdcall * X3D_OdeAddCylinder)(double object, double length, double radius);
...
double (__stdcall * X3D_OdeSurfaceSetRollingFrictionCoeff)(double body, double rfc);
double (__stdcall * X3D_OdeSurfaceEnableRollingFrictionCoeff)(double body, double mode);
double (__stdcall * X3D_OdeSurfaceSetMode)(double body, double Mu2, double FDir1, double Bounce, double SoftERP, double SoftCFM, double Motion1, double Motion2, double Slip1, double Slip2);
...
double (__stdcall * X3D_OdeJointSetObjects)(double joint, double object1, double object2);
...
double (__stdcall * X3D_OdeJointSetAnchor)(double joint, double x, double y, double z);
double (__stdcall * X3D_OdeJointSetAnchorAtObject)(double joint, double object);
double (__stdcall * X3D_OdeJointSetAxis1)(double joint, double x, double y, double z);
double (__stdcall * X3D_OdeJointSetAxis2)(double joint, double x, double y, double z);
double (__stdcall * X3D_OdeJointSetBounce)(double joint, double axis, double bounce);
double (__stdcall * X3D_OdeJointSetCFM)(double joint, double axis, double cfm);
double (__stdcall * X3D_OdeJointSetFMax)(double joint, double axis, double fmax);
double (__stdcall * X3D_OdeJointSetFudgeFactor)(double joint, double axis, double fmax);
double (__stdcall * X3D_OdeJointSetHiStop)(double joint, double axis, double histop);
double (__stdcall * X3D_OdeJointSetLoStop)(double joint, double axis, double lostop);
double (__stdcall * X3D_OdeJointSetStopCFM)(double joint, double axis, double cfm);
double (__stdcall * X3D_OdeJointSetStopERP)(double joint, double axis, double erp);
double (__stdcall * X3D_OdeJointSetVel)(double joint, double axis, double velocity);
