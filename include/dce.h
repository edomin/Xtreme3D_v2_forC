...
double (__stdcall * X3D_DceManagerSetWorldDirection)(double manager, double x, double y, double z);
double (__stdcall * X3D_DceManagerSetWorldScale)(double manager, double scale);
double (__stdcall * X3D_DceManagerSetMovementScale)(double manager, double scale);
...
double (__stdcall * X3D_DceSetSize)(double object, double x, double y, double z);
double (__stdcall * X3D_DceSetSlideOrBounce)(double object, double csb);
double (__stdcall * X3D_DceApplyAcceleration)(double object, double x, double y, double z);
double (__stdcall * X3D_DceApplyAbsAcceleration)(double object, double x, double y, double z);
...
double (__stdcall * X3D_DceMove)(double object, double x, double y, double z, double delta);
double (__stdcall * X3D_DceMoveTo)(double object, double x, double y, double z, double amount);
double (__stdcall * X3D_DceSetSpeed)(double object, double x, double y, double z);
...
double (__stdcall * X3D_DceStaticSetSize)(double object, double x, double y, double z);
...
double (__stdcall * X3D_DceGetCollisionPosition)(double object, double col, double ind);
double (__stdcall * X3D_DceGetCollisionNormal)(double object, double col, double ind);
