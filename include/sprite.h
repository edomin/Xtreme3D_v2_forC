...
double (__stdcall * X3D_HUDSpriteCreate)(char *material, double width, double height, double parent);
double (__stdcall * X3D_SpriteCreate)(char *material, double width, double height, double parent);
double (__stdcall * X3D_SpriteSetSize)(double sprite, double width, double height);
