...
double (__stdcall * X3D_MeshRotate)(double object, double x, double y, double z,
                                    double angle);
double (__stdcall * X3D_MeshExplode)(double object, double sp, double max,
...
double (__stdcall * X3D_MeshSmoothFaces)(double object, double weld,
                                         double threshold);
#endif
