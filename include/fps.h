...
double (__stdcall * X3D_FpsManagerSetMovementScale)(double manager,
                                                    double scale);
...
double (__stdcall * X3D_FpsGetCollisionPosition)(double object, double col,
                                                 double ind);
double (__stdcall * X3D_FpsGetCollisionNormal)(double object, double col,
                                               double ind);
