...
double (__stdcall * X3D_ViewerCreate)(double x, double y, double vwidth,
                                      double vheight);
...
double (__stdcall * X3D_ViewerResize)(double viewer, double x, double y,
...
double (__stdcall * X3D_ViewerSetFogDistance)(double viewer, double f_start,
                                              double f_end);
double (__stdcall * X3D_ViewerScreenToWorld)(double viewer, double x, double y,
                                             double ind);
double (__stdcall * X3D_ViewerWorldToScreen)(double viewer, double x, double y,
                                             double z, double ind);
