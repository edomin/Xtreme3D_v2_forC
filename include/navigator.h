...
double (__stdcall * X3D_NavigatorSetVirtualUp)(double nav, double x, double y,
                                               double z);
...
double (__stdcall * X3D_NavigatorMoveUpWhenMovingForward)(double nav,
                                                          double mode);
double (__stdcall * X3D_NavigatorInvertHorizontalWhenUpsideDown)(double nav,
                                                                  double mode);
