...
double (__stdcall * X3D_FireFXSetColor)(double manager, double incolor,
                                        double inalpha, double outcolor,
                                        double outalpha);
double (__stdcall * X3D_FireFXSetMaxParticles)(double manager,
                                               double particles);
...
double (__stdcall * X3D_FireFXSetEvaporation)(double manager,
                                              double evaporation);
...
double (__stdcall * X3D_FireFXExplosion)(double manager, double isp,
                                         double maxsp, double lbf);
