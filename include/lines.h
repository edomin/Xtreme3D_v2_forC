...
double (__stdcall * X3D_LinesAddNode)(double line, double x, double y, double z);
double (__stdcall * X3D_LinesDeleteNode)(double line, double ind);
double (__stdcall * X3D_LinesSetColors)(double line, double linecolor, double linealpha, double nodecolor, double nodealpha);
double (__stdcall * X3D_LinesSetSize)(double line, double linewidth, double nodesize);
