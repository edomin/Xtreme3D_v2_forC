...
double (__stdcall * X3D_LightSetAttenuation)(double light, double constant, double linear, double quadratic);
...
double (__stdcall * X3D_LightSetSpotDirection)(double light, double x, double y, double z);
