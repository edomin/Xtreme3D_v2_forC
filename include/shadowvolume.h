...
double (__stdcall * X3D_ShadowvolumeSetDarkeningColor)(double sv, double color, double a);
double (__stdcall * X3D_ShadowvolumeSetMode)(double sv, double mode);
double (__stdcall * X3D_ShadowvolumeSetOptions)(double sv, double op1, double op2, double op3, double op4);
